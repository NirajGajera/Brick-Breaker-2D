    ...
    void FixedUpdate ()
    {
        ...
        if (LevelManager.instance.gatherBalls == false && isTouchPosInGameArea)
        {
            ...
            if (nArrivedBallsBack >= numberBalls)
            {
                ...
                gamemanager.instance.twoButtons.SetActive(true);
            ...
            if (Input.GetMouseButtonUp(0))
            {
                ...
                gamemanager.instance.gatherButton.SetActive(true);
                gamemanager.instance.twoButtons.SetActive(false);
            }
#endif
